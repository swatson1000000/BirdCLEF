"""Merge 2 Perch-extraction partitions into a single dataset staging dir.

Reads:  /tmp/perch_ss_p{0,1}/full_train_soundscapes_{perch,meta}_p{0,1}of2.{npz,parquet}
...
PARTITION_COUNT = 2
PART_DIRS = [Path(f"/tmp/perch_ss_p{i}") for i in range(PARTITION_COUNT)]
STAGE = Path("/home/swatson/work/kaggle/BirdCLEF/four_track/kaggle_datasets/train-soundscapes-perch")
